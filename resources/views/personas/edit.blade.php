...
@section('content')
    <div class="container-fluid"
        style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); min-height: 100vh; padding: 2rem 0;">
        <div class="container">
            <div class="page-title">
                <h1><i class="fas fa-user-edit me-3"></i>Editar Persona</h1>
                <p>Modifique la información de
                    <strong>{{ trim($persona->primer_nombre . ' ' . $persona->primer_apellido) }}</strong></p>
            </div>
            ...
            <form action="{{ route('personas.update', $persona) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="wizard-step">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control select2" name="tipo_documento" id="tipo_documento_select"
                                    ...
                                    @foreach (App\Helpers\TipoDocumentoHelper::getOpciones() as $value => $label)
                                        <option value="{{ $value }}"
                                            {{ old('tipo_documento', $persona->tipo_documento_id) == $value ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="segundo_apellido_input" class="form-label">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="fecha_nacimiento_input" class="form-label">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control select2" name="sexo" id="sexo_select" required>
                                    ...
                                    @foreach (App\Helpers\SexoHelper::getOpciones() as $value => $label)
                                        <option value="{{ $value }}"
                                            {{ old('sexo', $persona->sexo_id) == $value ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('sexo')
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="identidad_genero" class="form-label">
                                ...
                                <select class="form-control select2" name="identidad_genero" id="identidad_genero_select"
                                    ...
                                    @foreach (App\Helpers\IdentidadGeneroHelper::getOpciones() as $value => $label)
                                        <option value="{{ $value }}"
                                            {{ old('identidad_genero', $persona->identidad_genero_id) == $value ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control select2" name="estado_civil" id="estado_civil_select"
                                    ...
                                    @foreach (App\Helpers\EstadoCivilHelper::getOpciones() as $value => $label)
                                        <option value="{{ $value }}"
                                            {{ old('estado_civil', $persona->estado_civil_id) == $value ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('estado_civil')
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control select2" name="ocupacion" id="ocupacion_select" required>
                                    ...
                                    @foreach (App\Helpers\OcupacionHelper::getOpciones() as $value => $label)
                                        <option value="{{ $value }}"
                                            {{ old('ocupacion', $persona->ocupacion_id) == $value ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('ocupacion')
                ...
                <div class="wizard-step">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="telefono_input" class="form-label">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="celular_input" class="form-label">
                                    <i class="fas fa-mobile-alt me-2"></i>Número de Celular *
                                </label>
                                <input type="text" class="form-control" id="celular_input" name="celular"
                                    value="{{ old('celular', $persona->celular) }}" placeholder="Número de celular"
                                    required>
                                @error('celular')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control select2" name="barrio" id="barrio_select" required>
                                    ...
                                    @foreach (App\Helpers\BarrioHelper::getOpciones() as $value => $label)
                                        <option value="{{ $value }}"
                                            {{ old('barrio', $persona->barrio_id) == $value ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('barrio')
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="direccion_input" class="form-label">
                                    <i class="fas fa-home me-2"></i>Dirección *
                                </label>
                                <input type="text" class="form-control" id="direccion_input" name="direccion"
                                    value="{{ old('direccion', $persona->direccion) }}" placeholder="Dirección completa"
                                    required>
                                @error('direccion')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                ...
                <div class="wizard-step">
                    ...
                    <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control select2" name="tipo_sangre" id="tipo_sangre_select" required>
                                    ...
                                    @foreach (App\Helpers\TipoSangreHelper::getOpciones() as $value => $label)
                                        <option value="{{ $value }}"
                                            {{ old('tipo_sangre', $persona->tipo_sangre_id) == $value ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('tipo_sangre')
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="factor_rh" class="form-label">
                                ...
                                <select class="form-control select2" name="factor_rh" id="factor_rh_select" required>
                                    ...
                                    @foreach (App\Helpers\FactorRhHelper::getOpciones() as $value => $label)
                                        <option value="{{ $value }}"
                                            {{ old('factor_rh', $persona->factor_rh_id) == $value ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('factor_rh')
                                ...
                                <div class="radio-group">
                                    <div class="radio-item">
                                        <input type="radio" name="afiliacion_salud" id="afiliacion_salud_si"
                                            value="1"
                                            {{ old('afiliacion_salud', $persona->afiliacion_salud) == '1' || old('afiliacion_salud', $persona->afiliacion_salud) === true ? 'checked' : '' }}>
                                        <label for="afiliacion_salud_si">Sí</label>
                                    </div>
                                    <div class="radio-item">
                                        <input type="radio" name="afiliacion_salud" id="afiliacion_salud_no"
                                            value="0"
                                            {{ old('afiliacion_salud', $persona->afiliacion_salud) == '0' || old('afiliacion_salud', $persona->afiliacion_salud) === false ? 'checked' : '' }}>
                                ...
                                <div class="radio-group">
                                    <div class="radio-item">
                                        <input type="radio" name="discapacidad" id="discapacidad_si" value="1"
                                            {{ old('discapacidad', $persona->discapacidad) == '1' || old('discapacidad', $persona->discapacidad) === true ? 'checked' : '' }}>
                                        <label for="discapacidad_si">Sí</label>
                                    </div>
                                    <div class="radio-item">
                                        <input type="radio" name="discapacidad" id="discapacidad_no" value="0"
                                            {{ old('discapacidad', $persona->discapacidad) == '0' || old('discapacidad', $persona->discapacidad) === false ? 'checked' : '' }}>
                    ...
                    <div class="conditional-fields" id="campos_afiliacion_salud"
                        style="display: {{ $persona->afiliacion_salud ? 'block' : 'none' }};">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="tipo_afiliacion_salud" class="form-label">
                                    ...
                                    <select class="form-control select2" name="tipo_afiliacion_salud"
                                        ...
                                        @foreach (App\Helpers\TipoAfiliacionSaludHelper::getOpciones() as $value => $label)
                                            <option value="{{ $value }}"
                                                {{ old('tipo_afiliacion_salud', $persona->tipo_afiliacion_salud_id) == $value ? 'selected' : '' }}>
                                                {{ $label }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2" name="eps" id="eps_select">
                                        ...
                                        @foreach (App\Helpers\EpsHelper::getOpciones() as $value => $label)
                                            <option value="{{ $value }}"
                                                {{ old('eps', $persona->eps_id) == $value ? 'selected' : '' }}>
                                                {{ $label }}</option>
                                        @endforeach
                                    </select>
                                    @error('eps')
                    ...
                    <div class="conditional-fields" id="campos_discapacidad"
                        style="display: {{ $persona->discapacidad ? 'block' : 'none' }};">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2" name="tipo_discapacidad"
                                        ...
                                        @foreach (App\Helpers\TipoDiscapacidadHelper::getOpciones() as $value => $label)
                                            <option value="{{ $value }}"
                                                {{ old('tipo_discapacidad', $persona->tipo_discapacidad_id) == $value ? 'selected' : '' }}>
                                                {{ $label }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="radio-group">
                                        <div class="radio-item">
                                            <input type="radio" name="atencion_integral_discapacidad"
                                                ...
                                                {{ old('atencion_integral_discapacidad', $persona->atencion_integral_discapacidad) == '1' || old('atencion_integral_discapacidad', $persona->atencion_integral_discapacidad) === true ? 'checked' : '' }}>
                                            <label for="atencion_integral_si">Sí</label>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" name="atencion_integral_discapacidad"
                                                id="atencion_integral_no" value="0"
                                                {{ old('atencion_integral_discapacidad', $persona->atencion_integral_discapacidad) == '0' || old('atencion_integral_discapacidad', $persona->atencion_integral_discapacidad) === false ? 'checked' : '' }}>
                ...
                <div class="wizard-step">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="pertenencia_etnica" class="form-label">
                                ...
                                <select class="form-control select2" name="pertenencia_etnica"
                                    ...
                                    @foreach (App\Helpers\PertenenciaEtnicaHelper::getOpciones() as $value => $label)
                                        <option value="{{ $value }}"
                                            {{ old('pertenencia_etnica', $persona->pertenencia_etnica_id) == $value ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="nombre_etnia_input" class="form-label">
                                    <i class="fas fa-users me-2"></i>Nombre de la Etnia (Opcional)
                                </label>
                                <input type="text" class="form-control" id="nombre_etnia_input" name="nombre_etnia"
                                    value="{{ old('nombre_etnia', $persona->nombre_etnia) }}"
                                    placeholder="Especifique el nombre de la etnia">
                                @error('nombre_etnia')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="action-buttons">
                    <div class="d-flex justify-content-center gap-3">
                        <a href="{{ route('personas.show', $persona) }}" class="btn btn-secondary-custom">
